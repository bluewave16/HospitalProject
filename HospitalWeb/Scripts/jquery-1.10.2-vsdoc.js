...
///     &#10;    2.1 - $(html, ownerDocclassmanagerent) 
///     &#10;    2.2 - $(html, props)
...
///     A DOM Element, Docclassmanagerent, or jQuery to use as context
/// </param>
/// <returns type="jQuery" />
...
"padding": {},
"borderWidth": {} };
jQuery.cssNclassmanagerber = { "colclassmanagernCount": true,
"fillOpacity": true,
"fontWeight": true,
"lineHeight": true,
"opacity": true,
...
/// <sclassmanagermary>
///     A generic iterator function, which can be used to seamlessly iterate over both objects and arrays. Arrays and array-like objects with a length property (such as a function's argclassmanagerents object) are iterated by nclassmanagereric index, from 0 to length-1. Other objects are iterated via their named properties.
/// </sclassmanagermary>
...
/// </param>
/// <param name="callback" type="Function">
///     The function to process each item against.  The first argclassmanagerent to the function is the item, and the second argclassmanagerent is the index.  The function should return a Boolean value.  this will be the global window object.
/// </param>
...
/// <sclassmanagermary>
///     Determine if the argclassmanagerent passed is a Javascript function object.
/// </sclassmanagermary>
/// <param name="obj" type="Object">
...
jQuery.isNclassmanagereric = function( obj ) {
/// <sclassmanagermary>
///     Determines whether its argclassmanagerent is a nclassmanagerber.
/// </sclassmanagermary>
/// <param name="obj" type="Object">
...
/// <sclassmanagermary>
///     Determine whether the argclassmanagerent is a window.
/// </sclassmanagermary>
/// <param name="obj" type="Object">
...
/// <sclassmanagermary>
///     Check to see if a DOM node is within an XML docclassmanagerent (or is an XML docclassmanagerent).
/// </sclassmanagermary>
/// <param name="elem" domElement="true">
///     The DOM node that will be checked to see if it's in an XML docclassmanagerent.
/// </param>
/// <returns type="Boolean" />
...
/// </param>
/// <param name="callback" type="Function">
///     The function to process each item against.  The first argclassmanagerent to the function is the array item, the second argclassmanagerent is the index in array The function can return any value. Within the function, this refers to the global (window) object.
/// </param>
/// <returns type="Array" />
...
jQuery.now = function() {
/// <sclassmanagermary>
///     Return a nclassmanagerber representing the current time.
/// </sclassmanagermary>
/// <returns type="Nclassmanagerber" />
...
/// <sclassmanagermary>
///     Parses a string into an XML docclassmanagerent.
/// </sclassmanagermary>
/// <param name="data" type="String">
///     a well-formed XML string to be parsed
/// </param>
/// <returns type="XMLDocclassmanagerent" />
...
/// <sclassmanagermary>
///     Sorts an array of DOM elements, in place, with the duplicates removed. Note that this only works on arrays of DOM elements, not strings or nclassmanagerbers.
/// </sclassmanagermary>
...
/// </param>
/// <param name="context" domElement="true">
///     The point in the docclassmanagerent at which the selector should begin matching; similar to the context argclassmanagerent of the $(selector, context) method.
/// </param>
/// <returns type="jQuery" />
...
/// </param>
/// <param name="speed" type="Nclassmanagerber">
///     A string or nclassmanagerber determining how long the animation will run.
/// </param>
...
/// </param>
/// <param name="value" type="Nclassmanagerber">
...
///     A Boolean indicating whether event handlers and data for all children of the cloned element should be copied. By default its value matches the first argclassmanagerent's value (which defaults to false).
/// </param>
/// <returns type="jQuery" />
...
/// </sclassmanagermary>
/// <param name="time" type="Nclassmanagerber">
///     An integer indicating the nclassmanagerber of milliseconds to delay execution of the next item in the queue.
/// </param>
/// <param name="type" type="String">
///     A string containing the name of the queue. Defaults to fx, the standard effects queue.
/// </param>
...
///     A string or nclassmanagerber determining how long the animation will run.
/// </param>
/// <param name="to" type="Nclassmanagerber">
///     A nclassmanagerber between 0 and 1 denoting the target opacity.
/// </param>
/// <param name="easing" type="String">
///     A string indicating which easing function to use for the transition.
/// </param>
...
jQuery.prototype.get = function( nclassmanager ) {
/// <sclassmanagermary>
///     Retrieve the DOM elements matched by the jQuery object.
/// </sclassmanagermary>
/// <param name="nclassmanager" type="Nclassmanagerber">
...
/// </sclassmanagermary>
/// <param name="margin" type="Nclassmanagerber">
///     An integer representing the nclassmanagerber of pixels, or an integer with an optional unit of measure appended (as a string).
/// </param>
/// <returns type="jQuery" />
...
/// <sclassmanagermary>
///     Check the current matched set of elements against a selector, element, or jQuery object and return true if at least one of these elements matches the given argclassmanagerents.
///     &#10;1 - is(selector) 
///     &#10;2 - is(function(index)) 
///     &#10;3 - is(jQuery object) 
///     &#10;4 - is(element)
...
/// <sclassmanagermary>
///     1: Get the current coordinates of the first element in the set of matched elements, relative to the docclassmanagerent.
///     &#10;    1.1 - offset()
///     &#10;2: Set the current coordinates of every element in the set of matched elements, relative to the docclassmanagerent.
...
///     &#10;2 - pushStack(elements, name, argclassmanagerents)
/// </sclassmanagermary>
/// <param name="elems" type="Array">
...
///     The argclassmanagerents that were passed in to the jQuery method (for serialization).
/// </param>
/// <returns type="jQuery" />
...
/// </sclassmanagermary>
/// <param name="val" type="Nclassmanagerber">
...
/// <sclassmanagermary>
///     Return the nclassmanagerber of elements in the jQuery object.
/// </sclassmanagermary>
/// <returns type="Nclassmanagerber" />
...
/// </sclassmanagermary>
/// <param name="" type="Nclassmanagerber">
...
///     &#10;1 - stop(clearQueue, jclassmanagerpToEnd) 
///     &#10;2 - stop(queue, clearQueue, jclassmanagerpToEnd)
/// </sclassmanagermary>
/// <param name="type" type="String">
...
/// <sclassmanagermary>
///     Add or remove one or more classes from each element in the set of matched elements, depending on either the class's presence or the value of the switch argclassmanagerent.
...
/// </sclassmanagermary>
/// <param name="margin" type="Nclassmanagerber">
///     An integer representing the nclassmanagerber of pixels, or an integer along with an optional unit of measure appended (as a string).
/// </param>
/// <returns type="jQuery" />
